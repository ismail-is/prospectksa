            ...
            <div className="lg:w-1/2 w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              {contactInfo.map((info, index) => (
                <a
                  key={index}
                  href={info.href}
                  className={`bg-white rounded-2xl p-6 border border-gray-100 hover:border-brand-orange/30 shadow-sm hover:shadow-md transition-all group flex flex-col justify-center ${index === 2 ? "sm:col-span-2" : ""
                    }`}
                >
